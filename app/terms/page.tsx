      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2" style={{ color: '#6B7280' }}>
            ...
            <li><strong>Promotional Marketing:</strong> Messages about offers, updates, and promotions from Resourceful Labs.</li>
            ...
            <li>To get help, reply <strong>HELP</strong> or contact <a href="mailto:support@resourcefullabs.com" style={{ color: '#059669' }}>support@resourcefullabs.com</a>.</li>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            For questions about these Terms, contact us at support@resourcefullabs.com or 4 Peddlers Row #1068, Newark, DE 19702.
          </p>
        </div>
      </section>
      <Footer />
