              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="accountNotifications" className="text-sm" style={{ color: '#6B7280' }}>
                    By checking this box, I agree to receive Account Notification SMS messages from Resourceful Labs at the phone number provided. I understand I may opt out at any time by replying STOP. Reply HELP for help. Message and data rates may apply. Message frequency varies. Opting in is optional and not required to submit this form. Consent is not required as a condition of purchasing any products or services. See our <a href="/privacy" style={{ color: '#059669' }}>Privacy Policy</a> and <a href="/terms" style={{ color: '#059669' }}>Terms of Service</a>.
                  </label>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="customerCare" className="text-sm" style={{ color: '#6B7280' }}>
                    By checking this box, I agree to receive Customer Care SMS messages from Resourceful Labs at the phone number provided. I understand I may opt out at any time by replying STOP. Reply HELP for help. Message and data rates may apply. Message frequency varies. Opting in is optional and not required to submit this form. Consent is not required as a condition of purchasing any products or services. See our <a href="/privacy" style={{ color: '#059669' }}>Privacy Policy</a> and <a href="/terms" style={{ color: '#059669' }}>Terms of Service</a>.
                  </label>
                </div>
              </div>
